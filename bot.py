...
from form_view import build_ytmp3_form_embed_view  # ฟอร์ม + ปุ่มอยู่ไฟล์นี้
...
# ---------------- คำสั่งส่งการ์ดฟอร์มแปลงเป็น MP3 (ทุกคนใช้ได้) ----------------

@bot.hybrid_command(
    name="ytmp3_form",
    description="ส่งการ์ดฟอร์มแปลง YouTube เป็น MP3 (มีรูป + ปุ่ม) ให้ทุกคนใช้",
)
