...
QueueStatusCallback = Callable[[discord.Interaction], Awaitable[str]]
...
class YTMP3View(discord.ui.View):
    def __init__(self, on_submit: FormCallback, on_check_queue: Optional[QueueStatusCallback] = None):
